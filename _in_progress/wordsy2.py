...
def scrabblehack(letters):
    for char in letters:## this builds the list of all words that you have at least one letter of
        skt=do_words_without_letters[char]
        if char not in scrabblewords:
            scrabblewords[char]=[(skt)]
        else:
            scrabblewords[char]+=[(skt)]
