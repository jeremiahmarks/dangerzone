 ...
 * @Last Modified time: 2015-04-14 21:38:25
 */
##
...
class Apple {
    ...
    public function add_item($itemName){
        global $conn;
        echo $_POST['newItem'];
    ...
    public function new_tag($displayText, $notes){
        global $conn;
        echo "I am here!";
    ...
    public function addTagToContactRecord($catchallid, $catchalltagid){
        global $conn;
    ...
    public function get_all_tagapplications(){
        global $conn;
    ...
    public function get_tags_applied($catchallid){
        global $conn;
    ...
    public function convert_data_to_HTMLoption($dataSet){
    ...
    public function get_tags_as_option(){
    ...
    public function get_catchall_all($catchallid){
        global $conn;
        $catchallAll=array();
